...
from utils import utils2 as utils
...
parser.add_argument('--dataset', type=str, default="dataset_right", help='Dataset you are using.')
...
for epoch in range(args.epoch_start_i, args.num_epochs):
    ...
    plt.savefig('./' + args.dataset + '/accuracy_vs_epochs.png')
    ...
    plt.savefig('./' + args.dataset + '/loss_vs_epochs.png')
    ...
    plt.savefig('./' + args.dataset + '/iou_vs_epochs.png')
