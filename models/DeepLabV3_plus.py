...
def Upsampling(inputs,feature_map_shape):
    return tf_v1.image.resize_bilinear(inputs, size=tf.cast(feature_map_shape, tf.int32))
...
def AtrousSpatialPyramidPoolingModule(inputs, depth=256):
    ...
    image_features = tf_v1.image.resize_bilinear(image_features, (feature_map_size[1], feature_map_size[2]))
